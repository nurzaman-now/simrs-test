    ...
    return (
        <GuestLayout>
            ...
            <div className="flex align-items-center justify-content-center flex-column">
                <img src="/images/logo/logo.jpg" alt="hyper" height={50} className="mb-3"/>
                <div className="surface-card p-6 sm:p-4 shadow-2 border-round w-full lg:w-4">
                    <div className="text-center mb-5">
                        ...
                        {/*<span className="text-600 font-medium line-height-3">Belum memiliki akun?</span>*/}
                        {/*<Link  href={route('register')} className="font-medium no-underline ml-2 text-blue-500 cursor-pointer">Buat Akun!</Link>*/}
                    </div>
                        ...
                        <div>
                            ...
                            <div className="flex align-items-center justify-content-between mb-6">
                                <div className="flex align-items-center">
                                    ...
                                    <label htmlFor="rememberme-login">Ingat Saya</label>
                                </div>
